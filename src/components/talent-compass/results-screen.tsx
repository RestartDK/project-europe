          ...
          <Table className="min-w-max">
            <TableHeader>
              <TableRow className="border-b border-border bg-secondary/40 hover:bg-secondary/40">
                ...
                <TableHead className={headCn}>headline</TableHead>
                <TableHead className={headCn}>company</TableHead>
                <TableHead className={headCn}>match</TableHead>
                <TableHead className={headCnCenter}>conf</TableHead>
                <TableHead className={headCn}>top stacks</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {results.map((r, i) => (
                ...
                >
                  <TableCell className={stickyCandidateCell}>
                    <div className="flex items-center gap-2.5">
                      <Avatar className="size-6 rounded-full">
                        <AvatarImage src="" alt={r.fullName} />
                  ...
                  <TableCell className="px-3 py-2.5 text-center">
                    <SignalCell value={Math.round(r.confidence)} />
                  </TableCell>
                  <TableCell className="px-4 py-2.5">
